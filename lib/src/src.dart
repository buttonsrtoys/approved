...
class Approved {
  ...
  static Future<void> tearDownAll() async {
    ...
    if (approvedFullPaths.isNotEmpty || approvedFullPaths.isNotEmpty) {
      print('''$topBar begin package:approved warning $topBar\n
    The files listed below were generated by approvalTest but are no longer used:\n''');
      ...
      print('''\n$bottomBar  end package:approved warning  $bottomBar''');
    }
...
Future<void> approvalTest(
  ...
  try {
    ...
    assert(!_executedApprovedFullPaths.contains(approvedFullPath), '''$topBar begin package:approved error $topBar
...
$topBar  end package:approved error  $topBar''');
